...
Route::middleware(['auth', 'verified'])->prefix('pay')->name('pay.')->group(function () {
    ...
    Route::get('/ledger', [LedgerWebController::class, 'index'])->name('ledger');
    Route::get('/batches/{ref}', [LedgerWebController::class, 'showBatch'])->name('batches.show');
    Route::get('/platform-accounts', [PlatformAccountWebController::class, 'index'])->name('platform');
